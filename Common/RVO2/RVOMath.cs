...
namespace RVO
{
    ...
    public struct RVOMath
    {
         ...
         */
        public static Fix64 abs(Vec2 vector)
        {
         ...
         */
        public static Fix64 absSq(Vec2 vector)
        {
         ...
         * matrix.</param>
         */
        internal static Fix64 det(Vec2 vector1, Vec2 vector2)
        {
         ...
         * be calculated.</param>
         */
        internal static Fix64 distSqPointLineSegment(Vec2 vector1, Vec2 vector2, Vec2 vector3)
        {
         ...
         * calculated.</param>
         */
        internal static Fix64 leftOf(Vec2 a, Vec2 b, Vec2 c)
        {
            return det(a - c, b - a);
        }
        ...
        {
            return (Fix64)Fix64.Sqrt(scalar);
        }
    }
}
