...
namespace RVO
{
    ...
    internal class Agent
    {
        ...
        internal Fix64 maxSpeedByConfig_ = Fix64.Zero;
        ...
        internal Simulator simulator_ = null;
         ...
         * </param>
         */
        private bool linearProgram1(IList<Line> lines, int lineNo, Fix64 radius, Vec2 optVelocity, bool directionOpt, ref Vec2 result)
        {
            ...
            for (int i = 0; i < lineNo; ++i)
            {
                ...
                if (denominator >= Fix64.Zero)
                {
                    ...
                    tRight = MathEx.Min(tRight, t);
                }
                else
                {
                    /* Line i bounds line lineNo on the left. */
                    tLeft = MathEx.Max(tLeft, t);
                }
         ...
         * </param>
         */
        private int linearProgram2(IList<Line> lines, Fix64 radius, Vec2 optVelocity, bool directionOpt, ref Vec2 result)
        {
            if (directionOpt)
            {
                /*
